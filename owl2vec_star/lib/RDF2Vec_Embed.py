...
"""
@Chavakan-2023-6-15
This function is for creating a Knowledge Graph and walker for the RDF graph walk to create Structure Document
The graph is created based on the ontology input file
...
def construct_kg_walker(onto_file, walker_type, walk_depth):
    ...
    create a relationship between s,p,o by making 3 node and connect them with 2 edges
    ...
    """
    @Chavakan-2023-6-15
    Create a walker besd on the input argumant
    """
